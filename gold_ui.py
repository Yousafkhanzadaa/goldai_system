...
st.title('GOLD AI')
st.write('Navigate between different pages by using navigations on the left side of the screen.')

st.title("Internal Pinecone")
st.write("Internal Pinecone is to embed internal documents totally related to GOLD AI")


st.title("Other Pinecone")
st.write("Other Pinecone is to embed global documents. no specifically internal docs.")
